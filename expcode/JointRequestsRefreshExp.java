...
public class JointRequestsRefreshExp<NodeIDType> implements InterfacePacketDemultiplexer<JSONObject>
{
	...
	public static void main(String [] args) throws Exception
	{
		...
		JointRequestsRefreshExp<Integer> basicObj 
									= new JointRequestsRefreshExp<Integer>(clientID);
		
		
		for(int i=0;i<NUM_QUERIES_IN_SYSTEM;i++)
		{
			basicObj.sendQuery(i);
			Thread.sleep(50);
		}
	...
	private static void sendAMessage(JointRequestsRefreshExp<Integer> basicObj)
	{	
		basicObj.requestID++;
	...
	public JointRequestsRefreshExp(NodeIDType id) throws Exception
	{
