...
public class ChurnExpUpdateClass<NodeIDType> implements InterfacePacketDemultiplexer<JSONObject>
{
	...
	public ChurnExpUpdateClass(NodeIDType id) throws Exception
	{
