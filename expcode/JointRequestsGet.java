...
public class JointRequestsGet<NodeIDType> implements InterfacePacketDemultiplexer<JSONObject>
{
	// 1% loss tolerance
		...
		public static void main(String [] args) throws Exception
		{
			...
			JointRequestsGet<Integer> basicObj = new JointRequestsGet<Integer>(clientID);
		...
		private static void sendAMessage(JointRequestsGet<Integer> basicObj)
		{
			basicObj.requestID++;
		...
		private class GoodPutThread implements Runnable
		{
			...
			public void run()
			{
				while(true)
				{
					...
					ContextServiceLogger.getLogger().fine("Goodput: "+goodput);
				}
			}
		}
}