							...
							Replicable, Reconfigurable, ClientMessenger, AppRequestParserBytes
{
			...
			boolean doNotReplyToClient) 
	{
		...
		{
			request.setResponse(TestAppRequest.ResponseCodes.ACK.toString() + " read of servicename "
			...
			boolean doNotReplyToClient) 
	{
		...
		if (DELEGATE_RESPONSE_MESSAGING)
		{
			request.setResponse(TestAppRequest.ResponseCodes.ACK.toString() + " write of servicename "
					+ request.getServiceName()
