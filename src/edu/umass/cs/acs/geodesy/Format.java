...
public class Format {
  ...
  //
   /**
   * TIME ONLY with just hours and minutes
   */
  public final static ThreadLocal<SimpleDateFormat> formatDateTimeOnlyHHmm =
          new ThreadLocal<SimpleDateFormat>() {
            @Override
            protected SimpleDateFormat initialValue() {
  ...
  /**
   * Parses date in HH:mm format.
   * 
   * @param text
   * @return the parsed date
   * @throws ParseException 
   */
  public static Date parseDateTimeOnlyHHmm(String text) throws ParseException {
    return formatDateTimeOnlyHHmm.get().parse(text);
  }
   ...
   * @return the formatted time
   */
  public static String formatDateTimeOnlyHHmm(Date date) {
    return formatDateTimeOnlyHHmm.get().format(date);
  }
  //
  ...
  /**
   * Parses date in HH:mm:ss format assuming UTC.
   * 
   * @param text
   * @return the parsed date
   * @throws ParseException 
