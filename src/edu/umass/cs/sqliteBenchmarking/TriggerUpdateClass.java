...
public class TriggerUpdateClass extends AbstractRequestSendingClass
{
	...
	private String returnRemovedGroupGUIDsQuery(JSONObject oldValJSON, JSONObject updateValJSON) throws JSONException
	{
		...
		String removedGroupQuery = "SELECT groupGUID, userIP, userPort FROM "
				+ SQLiteThroughputBenchmarking.triggerTableName
				+ " WHERE "
	...
	{
		String tableName 			= SQLiteThroughputBenchmarking.triggerTableName;
			...
			throws JSONException
	{
		...
		for( int i=0; i<SQLiteThroughputBenchmarking.numAttrs; i++ )
		{
			...
			String minVal = SQLiteThroughputBenchmarking.ATTR_MIN+"";
			String maxVal = SQLiteThroughputBenchmarking.ATTR_MAX+"";
			...
			if( first )
			{
				...
				if(SQLiteThroughputBenchmarking.disableCircularQueryTrigger)
				{
