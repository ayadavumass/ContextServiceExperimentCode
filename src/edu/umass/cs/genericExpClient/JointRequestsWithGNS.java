...
public class JointRequestsWithGNS<NodeIDType> implements PacketDemultiplexer<JSONObject>
{
	...
	public static void main(String [] args) throws Exception
	{
		...
		JointRequestsWithGNS<Integer> basicObj 
														= new JointRequestsWithGNS<Integer>(clientID);
	...
	private static void sendAMessage(JointRequestsWithGNS<Integer> basicObj)
	{
		basicObj.requestID++;
	...
	public JointRequestsWithGNS(NodeIDType id) throws Exception
	{
	...
	public class SendingRequest implements Runnable
	{
		...
		private void sendQueryToContextService(String query, long userReqNum) throws IOException, JSONException
		{
			QueryMsgFromUser<NodeIDType> qmesgU 
				= new QueryMsgFromUser<NodeIDType>(myID, query, userReqNum, 
						300000, sourceIP, sourcePort);
		...
		public void sendUpdateToContextService(long versionNum, String attrName, double oldVal, double newVal, String GUID)
		{
			try
			{
				...
				(myID, versionNum, GUID, attrValuePair, versionNum, sourceIP, sourcePort, 
