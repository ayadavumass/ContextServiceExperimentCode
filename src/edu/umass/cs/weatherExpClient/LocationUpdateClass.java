 ...
 * @author adipc
 */
public class LocationUpdateClass extends AbstractRequestSendingClass implements Runnable
{
	private final Random updateRand;
	public LocationUpdateClass()
	{
	...
	private void sendALocMessage(int currUserGuidNum)
	{
		...
		if( currUserInfo.getUserActivity() == WeatherAndMobilityBoth.STATE_DRIVING )
		{
			...
			{
				newLat = WeatherAndMobilityBoth.LATITUDE_MIN 
			...
			{
				newLong = WeatherAndMobilityBoth.LONGITUDE_MIN 
