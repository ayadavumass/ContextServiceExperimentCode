...
{	
	...
	public UpdateClass()
	{
		super(ThroughputMeasure.UPD_LOSS_TOLERANCE);
	...
	{
		double reqspms = ThroughputMeasure.updateRequestsps/1000.0;
		long currTime = 0;
		...
		while( ( (System.currentTimeMillis() - expStartTime) < ThroughputMeasure.EXPERIMENT_TIME ) )
		{
			for(int i=0; i<numberShouldBeSentPerSleep; i++ )
			{
				...
				currUserGuidNum++;
				currUserGuidNum=((int)currUserGuidNum)%ThroughputMeasure.numGuids;
				//numSent++;
			}
	...
	{
		numSent++;
		String guid = ThroughputMeasure.getSHA1(ThroughputMeasure.guidPrefix+currUserGuidNum);
		...
		ThroughputMeasure.taskES.execute(updTask);
	}
